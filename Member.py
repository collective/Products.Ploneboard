...
id_schema = Schema((
    StringField('id',
                ...
                default=None,
                index=('member_catalog/ZCTIndex|FieldIndex|TextIndex:brains', 'FieldIndex|TextIndex:brains'),
                ...
                regfield=1,       ### flags this field as part of the registration form
                ),
))
...
contact_schema = Schema((
    StringField('fullname',
                ...
                index=('member_catalog/ZCTIndex|FieldIndex|TextIndex:brains','ZCTIndex|FieldIndex|TextIndex:brains'),
