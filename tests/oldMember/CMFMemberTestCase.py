...
ZopeTestCase.installProduct('OldCMFMember')
...
from Products.OldCMFMember.Extensions.Install import install as install_oldcmfmember
...
install_archetypes(app[portal_name])
install_oldcmfmember(app[portal_name])
get_transaction().commit()
