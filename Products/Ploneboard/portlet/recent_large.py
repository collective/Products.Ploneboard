...
class IRecentConversationsLargePortlet(IPortletDataProvider):
...
class Assignment(base.Assignment):
    implements(IRecentConversationsLargePortlet)
...
class Renderer(base.Renderer):
    ...
    def results(self):
        ...
        def morph(brain):
            ...
            last_comment_creator = last_comment.Creator()
            mt = getToolByName(self.context, "portal_membership")
            creatorInfo = mt.getMemberInfo(last_comment_creator)
            if creatorInfo is not None and creatorInfo.get('fullname', '') != "":
                last_comment_creator = creatorInfo['fullname']
            ...
            return dict(
                    ...
                    last_comment_creator = last_comment_creator,
                    last_comment_date = toPloneboardTime(self.context, self.request, last_comment.created()),
                    num_comments = obj.getNumberOfComments(),
                )
    ...
    render = ViewPageTemplateFile("recent_large.pt")


class AddForm(base.AddForm):
    form_fields = Fields(IRecentConversationsLargePortlet)
