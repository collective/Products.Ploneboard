...
# Date: 2004/06/02 20:45:47.415 GMT-7
#
...
def setupMember_approval_workflow(wf):
    ...
    sdef.setPermission('Set own password', 0, ['Manager', 'Owner'])
    sdef.setPermission('Manage users', 0, ['Manager'])
    sdef.setPermission('CMFMember: View', 0, ['Authenticated', 'Manager', 'Member', 'Owner'])
    sdef.setPermission('View', 0, ['Authenticated', 'Manager', 'Member', 'Owner'])
    sdef.setPermission('Modify portal content', 0, ['Manager', 'Owner'])
