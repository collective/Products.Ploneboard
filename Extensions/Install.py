...
def install_Skins(self, out):
    ...
    try:
        ...
        install_SubSkin(self, out, 'contentpanels/content_views')
        install_SubSkin(self, out, 'contentpanels/panel_slots')
...
def install(self):
    ...
    out = StringIO()
    out.write( 'CMFContentPanels installation tool v' + str(__version__) + '.\n')
    ...
    wf_tool.setChainForPortalTypes( ('ContentPanels',), [])
    out.write('Removed workflow for ContentPanels')
