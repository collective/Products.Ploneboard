...
License:
    ...
    ATSchemaEditorNG is (C) by Andreas Jung and published as open-source
...
Contributions:
    ...
    Simon Spamies: fixes, code cleanup, schema update mechanism revisited (and most of the stuff in V 0.2)
